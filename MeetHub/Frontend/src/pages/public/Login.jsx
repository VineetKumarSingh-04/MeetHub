      ...
      <div className="min-h-screen mesh-bg text-white flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="glass-card rounded-2xl p-8 shadow-2xl anim-slide">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mb-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 text-sm text-slate-400 cursor-pointer">
                  <input type="checkbox" checked={form.remember} onChange={e => setForm({...form, remember: e.target.checked})} className="w-4 h-4 rounded" />
                  Remember me
                </label>
                <button type="button" onClick={() => navigate("/forgot-password")} className="text-sm text-indigo-400 hover:text-indigo-300 transition-colors">
                  Forgot password?
                </button>
              </div>
            ...
            <div className="divider"><span className="text-sm text-slate-400">Or continue with</span></div>
            ...
            <p className="text-center text-slate-400 text-sm">
              ...
              <button onClick={() => navigate("/signup")} className="text-indigo-400 hover:text-indigo-300 font-semibold transition-colors">
                Sign up
              </button>
            </p>
          </div>
